Public Module DLLAuthentication
    ...
    Public Function Authenticate(ByVal EncrAuthkey1 As String, ByVal EncrAuthkey2 As String, ByVal Passphrase As String, ByVal EncrProgramName As String) As Boolean
    ...
    Public Function IsAuthed() As Boolean
